...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url('LMS-MBKM/LMS/asset/css/fonts.google.css');?>" />

    <link rel="stylesheet" href="<?php echo base_url('LMS-MBKM/LMS/asset/css/bootstrap.min.css');?>" />
    <link rel="stylesheet" href="<?php echo base_url('LMS-MBKM/LMS/asset/css/datatables.min.css');?>" />

    <link rel="stylesheet" href="<?php echo base_url('LMS-MBKM/LMS/asset/css/font-awesome.min.css');?>">
    <link rel="stylesheet" href="<?php echo base_url('LMS-MBKM/LMS/asset/css/style.css');?>" />
		...
		<div class="row" id="logindiv">	
			<div class="col-md-12">
				<div class="col-md-4 col-sm-12 col-xs-12">
		            <img src="<?php echo base_url().'LMS-MBKM/LMS/asset/image/login.jpg';?>" class="img-responsive">
		        </div>		
		...
		<div class="row" id="signupdiv" style="display: none;">
			<div class="col-md-12">
				<div class="col-md-3 col-sm-12 col-xs-12">
		            <img src="<?php echo base_url().'LMS-MBKM/LMS/asset/image/signup.png';?>" class="img-responsive">
		        </div>				
...
<script src="<?php echo base_url('LMS-MBKM/LMS/asset/js/jquery.min.js');?>"></script>
<script src="<?php echo base_url('LMS-MBKM/LMS/asset/js/menu-scrollbar.min.js');?>"></script>
<script src="<?php echo base_url('LMS-MBKM/LMS/asset/js/application.js');?>"></script>
