				...
				<form id="questionnaire_form" class="clearfix" style="margin-top: 10px;">
					<div class="col-md-12">
						<div class="section-title">
							<h4 class="title">Informasi Pertanyaan</h4>
						</div>
					</div>
					...
					<div class="col-md-3">
						<div class="form-group">
							<input type="radio" name="right_answer" id="right_answer" value="1"> &nbsp;Jawaban Benar
					...
					<div class="col-md-3">
						<div class="form-group">
							<input type="radio" name="right_answer" id="right_answer" value="2"> &nbsp;Jawaban Benar
					...
					<div class="col-md-3">
						<div class="form-group">
							<input type="radio" name="right_answer" id="right_answer" value="3"> &nbsp;Jawaban Benar
							<input class="input" type="text" id="answer_3" name="answer_3" value="">
						</div>
					</div>
					<div class="col-md-3">
						<div class="form-group">
							<input type="radio" name="right_answer" id="right_answer" value="4"> &nbsp;Jawaban Benar
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<button type="button" class="btn btn-success" id="btn_submit" onclick="submit_form();" style="float: right;"> Simpan Pertanyaan</button>
						</div>
					</div>
				</form>
			</div>
        ...
        <div class="modal-content">
            <div class="modal-body form">
                <form id="questionnaire_update_form" class="clearfix" style="margin-top: 10px;">
					...
					<div class="col-md-6">
						<div class="form-group">
							<input type="radio" name="update_right_answer" id="update_right_answer" value="1"> &nbsp;Jawaban Benar
							<input class="input" type="text" id="update_answer_1" name="update_answer_1" value="">
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
							<input type="radio" name="update_right_answer" id="update_right_answer" value="2"> &nbsp;Jawaban Benar
							<input class="input" type="text" id="update_answer_2" name="update_answer_2" value="">
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
							<input type="radio" name="update_right_answer" id="update_right_answer" value="3"> &nbsp;Jawaban Benar
							<input class="input" type="text" id="update_answer_3" name="update_answer_3" value="">
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
							<input type="radio" name="update_right_answer" id="update_right_answer" value="4"> &nbsp;Jawaban Benar
