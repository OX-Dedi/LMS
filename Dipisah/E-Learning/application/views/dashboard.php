            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="panel panel-primary" style="min-height: 320px;">
                    <div class="panel-heading">
                        <i class="fa fa-bars fa-fw"></i> Laporan yang sudah mengerjakan Course
                    </div>                
                            ...
                            <table class="table table-bordered table-hover">
                                <tbody>
                                    ...
                                    if(isset($evaluation_report) && count($evaluation_report) > 0 ) { 
                                        echo "<tr style='background-color:#F5F5F5;'><td style='width: 5%;text-align:center;'>No</td><td style='width: 25%;'>Tanggal Test</td><td style='width: 30%;'>Nama Matakuliah</td><td style='width: 30%;'>Materi</td><td style='width: 10%;'>Detail</td></tr>";
