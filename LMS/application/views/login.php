//LOGIN LMS INI YANG NABRAK DENGAN LOGIN YANG ADA DI VIEW AUTH,DAN KETIKA DAFTAR AKUN BISA DI CEK DI DB APP_USER UNTUK YG INI KOSONG PW NYA.
<!DOCTYPE html>
<html>
<head>
	...
	<link rel="icon" href="http://localhost/LMS-MBKM/LMS/asset/image/icon.png">

	<link rel="stylesheet" href="http://localhost/LMS-MBKM/LMS/asset/css/fonts.google.css" />

	<link rel="stylesheet" href="http://localhost/LMS-MBKM/LMS/asset/css/bootstrap.min.css" />
	<link rel="stylesheet" href="http://localhost/LMS-MBKM/LMS/asset/css/datatables.min.css" />

	<link rel="stylesheet" href="http://localhost/LMS-MBKM/LMS/asset/css/font-awesome.min.css">
	<link rel="stylesheet" href="http://localhost/LMS-MBKM/LMS/asset/css/style.css" />
</head>
<body>
	...
	<div class="container">
		<div class="row" id="logindiv">	
			<div class="col-md-12">
				...
				<img src="http://localhost/LMS-MBKM/LMS/asset/image/login.jpg" class="img-responsive">
		        </div>		
				<div class="col-md-5 col-sm-12 col-xs-12 shadow-border" style="margin-bottom:15px;">
					<form id="login_form" method="post" class="padding-top-10">	
						...
						<div class="col-md-12">
							<div class="form-group">
								<p>Kata Sandi <span style="color: red;">*</span></p>
				...
				<div class="col-md-offset-4 col-md-5 col-sm-12 col-xs-12" style="border: 1px solid green; background-color: #C8E5A7;">
					<p class="padding-top-10" style="padding-bottom:5px;text-align: center; font-size: 16px;color: black;">Tidak Memiliki Akun? <i class="fa fa-frown-o" style="color:red;font-size:20px"></i> &nbsp;&nbsp;<a href="#" class="signup" style="color: blue;"> <u>Daftar Disini</u> </a></p>
				</div>
			</div>
		</div>
		...
		<div class="row" id="signupdiv" style="display: none;">
			<div class="col-md-12">
				...
				<img src="http://localhost/LMS-MBKM/LMS/asset/image/signup.png" class="img-responsive">
		        </div>				
				<div class="col-md-7 col-sm-12 col-xs-12 shadow-border" style="background: white;padding-bottom:10px;margin-bottom:15px;">
					<form id="signup_form" method="post">	
						...
						<div class="col-md-6 col-sm-12 col-xs-12 padding-top-10">
							<div class="form-group">
								<button type="button" class="btn btn-success" id="btn_signup" style="width:100%;" onclick="submitSignupForm();">Selesai Registrasi</button>
							</div>
						</div>
				...
				<div class="col-md-offset-3 col-md-7 col-sm-12 col-xs-12" style="border: 1px solid green; background-color: #C8E5A7;">
					<p class="padding-top-10" style="padding-bottom:5px;text-align: center; font-size: 16px;color: black;">Sudah Memiliki Akun? <i class="fa fa-smile-o" style="color:green;font-size:20px"></i> &nbsp;&nbsp;<a href="#" class="login" style="color: blue;"> <u>Login Disini</u> </a></p>
				</div>
			</div>
		</div>
	</div>
...
<script src="http://localhost/LMS-MBKM/LMS/asset/js/jquery.min.js"></script>
<script src="http://localhost/LMS-MBKM/LMS/asset/js/menu-scrollbar.min.js"></script>
<script src="http://localhost/LMS-MBKM/LMS/asset/js/application.js"></script>
