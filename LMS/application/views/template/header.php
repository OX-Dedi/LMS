  ...
  <div id="top-header">
    <div class="container">
      ...
      <div class="pull-left">
        <ul>
          <li>
            <a href="#" style="font-size: 20px;color: white;font-weight: bold;">LMS</a>
          </li>
        </ul>
      </div>
            ...
            <ul class="custom-menu">
              ...
              <li>
                <a href="<?php echo base_url();?>course">
                  <i class="fa fa-address-card-o"></i> Matakuliah
                </a>
              </li>            

              <li class="temp">
                <a href="<?php echo base_url();?>lesson">
                  <i class="fa fa-arrow-circle-o-right"></i> Materi
                </a>
              </li>
              
              <li class="temp">
                <a href="<?php echo base_url();?>questionnaire">
                  <i class="fa fa-list"></i> Pertanyaan
                </a>
              </li>

              <li class="temp">
                <a href="<?php echo base_url();?>app_user/list">
                  <i class="fa fa-group"></i> Tampilkan User
                </a>
              </li>
              <?php } ?>
